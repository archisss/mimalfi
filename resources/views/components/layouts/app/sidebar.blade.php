        ...
        <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navlist variant="outline">
                <flux:navlist.group :heading="__('Administrador')" class="grid">
                    ...
                    <flux:navlist.item icon="document-currency-dollar" :href="route('admin.loantypes.loantypeslist')" :current="request()->routeIs('dashboard')" wire:navigate>
                    ...
                    <flux:navlist.item :href="route('admin.loans.create')" :current="request()->routeIs('Prestamo')" wire:navigate style="margin-left: 28px">
                    {{ __('Nuevo') }}</flux:navlist.item>
                    <flux:navlist.item :href="route('admin.loans.loanlist')" :current="request()->routeIs('Prestamo')" wire:navigate style="margin-left: 28px">
                    {{ __('Listado') }}</flux:navlist.item>

                    <flux:navlist.item icon="user" :href="route('admin.users.create')" :current="request()->routeIs('dashboard')" wire:navigate>
