        ...
        <tbody>
            @foreach($loans as $loan)
                <tr class="border-b">
                    ...
                    <td class="p-2">{{ $loan->payment_date ?? 'N/A' }}</td>
                    ...
                    @else   
                        <flux:button wire:click="confirmFinalize({{ $loan->id }})" icon="currency-dollar" tooltip="Pagar" onclick="window.location.href='/admin/collect?selectedDay={{ $loan->payment_date }}';" />
